...
ds = pd.read_csv(r"C:\Users\AJAY\Desktop\student\student-mat.csv", sep=";")
...
def main():
   ...
   # Remove grade report 2
    ...
    bg_i=ImageTk.PhotoImage(file=r"C:\Users\AJAY\Desktop\student\Tracking_Headline.png")
    bg_l = Label(root, image=bg_i,bg="dimgray")
    bg_l.place(x=10, y=200,width=500,height=300)
    bg_i2=ImageTk.PhotoImage(file=r"C:\Users\AJAY\Desktop\student\suggestions.png")
    ...
    def success():
        ...
        bg_i=ImageTk.PhotoImage(file=r"C:\Users\AJAY\Desktop\student\success.png")
    ...
    def failure():
        ...
        tp.geometry("400x400+0+0")
        tp.configure(background="dimgray")
        bg_i=ImageTk.PhotoImage(file=r"C:\Users\AJAY\Desktop\student\failure.png")
        bg_l = Label(tp, image=bg_i,bg="dimgray")
        bg_l.place(x=40, y=10,width=300,height=300)
